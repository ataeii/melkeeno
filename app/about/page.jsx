...
export const metadata = {
  title: 'درباره ما | ملکینو',
  description: 'ملکینو چیست و چه خدماتی برای جستجوی ملک، اجاره و خرید خانه در تهران ارائه می‌دهد.',
};

const AboutPage = () => {
  return (
    <section dir='rtl' className='max-w-3xl mx-auto px-4 py-8'>
      <h1 className='text-2xl font-extrabold text-gray-800 mb-2'>درباره ملکینو</h1>
      ...
      <div className='bg-white rounded-xl shadow-md p-6 space-y-6 text-sm leading-7 text-gray-700'>
        <div>
          ...
          <p>
            ملکینو با این هدف ساخته شده که جستجوی خانه در تهران را از یک فرآیند خسته‌کننده و پر از آگهی‌های تکراری یا غیرواقعی،
